...
import MovieTableRow from '@/views/dashboard/components/layout_components/movie/TableRow.vue'
import ShowTableRow from '@/views/dashboard/components/layout_components/show/TableRow.vue'
import InfiniteLoading from 'vue-infinite-loading'
import transparentRow from '@/mixins/transparentTableRow'

export default {
  name: 'TableView',
  components: { InfiniteLoading, MovieTableRow, ShowTableRow },
