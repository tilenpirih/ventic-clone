...
import DetailGridCard from '@/views/dashboard/components/layout_components/movie/DetailGridCard.vue'
import InfiniteLoading from 'vue-infinite-loading'

export default {
  name: 'DetailedGridView',
  components: { DetailGridCard, InfiniteLoading },
  ...
  methods: {
    onResize() {
      ...
      this.itemHeight = (((container - 12 - numOfMovies * 12) / numOfMovies) * 3) / 2 + 60
