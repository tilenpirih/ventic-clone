  ...
  <div>
    ...
    >
      <template #default="{ item }">
        <DetailTableRow v-if="item !== true" :movie="item" :style="transparentRow(item.index)" />
        <infinite-loading
...
import DetailTableRow from '@/views/dashboard/components/layout_components/movie/DetailTableRow.vue'
import InfiniteLoading from 'vue-infinite-loading'
import transparentRow from '@/mixins/transparentTableRow'

export default {
  name: 'DetailTableView',
  components: { InfiniteLoading, DetailTableRow },
