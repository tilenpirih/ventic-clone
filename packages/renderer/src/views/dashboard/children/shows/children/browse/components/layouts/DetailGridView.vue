...
import DetailGridCard from '@/views/dashboard/components/layout_components/show/DetailGridCard.vue'
...
export default {
  ...
  methods: {
    onResize() {
      ...
      this.itemHeight = (((container - 12 - numOfShows * 12) / numOfShows) * 3) / 2 + 60
