  ...
  <div>
    ...
    >
      <template #default="{ item }">
        <DetailTableRow v-if="item !== true" :show="item" :style="transparentRow(item.index)" />
        <infinite-loading
...
import DetailTableRow from '@/views/dashboard/components/layout_components/show/DetailTableRow.vue'
